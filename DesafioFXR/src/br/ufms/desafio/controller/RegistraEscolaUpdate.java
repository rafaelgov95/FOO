 ...
 */
public class RegistraEscolaUpdate extends TrocarCena implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tfNomeEscola.setText(Buffer.user.getNome());
    ...
    private void criar(ActionEvent event) {
        if (pfSenha2.getText().equals("") || tfNomeEscola.getText().equals("")
            ...
            try {
                ...
                Escola escola = escolaDAO.get(Buffer.user.getCodigo());
