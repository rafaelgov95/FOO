 ...
 */
public class RegistraProfessor extends TrocarCena implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            Logger.getLogger(RegistraProfessor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void configuracoes(ActionEvent event) {
        trocarCena(event, "br/ufms/desafio/view/fxml/Config_tela_1.fxml");
    }
