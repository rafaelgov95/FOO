...
public class Responsavel extends Jogador implements Serializable {
    ...
    /**
     * Cria um novo objeto Responsavel com o CPF nulo e a lista de dependências
     * vazia. O restante dos atributos são inicializados conforme os
     * construtores das superclasses Jogador e Usuario.
     */
    public Responsavel() {
