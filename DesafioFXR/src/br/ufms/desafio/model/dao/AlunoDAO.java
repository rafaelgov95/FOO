...
public class AlunoDAO extends JogadorDAO<Aluno> {
    ...
    protected String sqlToGetAll() {
        return "SELECT * FROM desafio.usuario u JOIN desafio.jogador j ON u.codigo = j.codigo JOIN desafio.aluno p ON j.codigo = p.codigo";

    }

    @Override
    protected List<Aluno> getAllString(Connection conn, String string) throws SQLException {
