...
public abstract class ReadOnlyDAO<B extends Bean<T>, T extends Serializable> {
    ...
    public List<B> getAllString(String string) throws SQLException {
        List<B> beans;
        try (Connection conn = db.getConnection()) {
            beans = getAllString(conn,string);
    ...
    protected abstract List<B> getAllString(Connection conn, String string) throws SQLException;
